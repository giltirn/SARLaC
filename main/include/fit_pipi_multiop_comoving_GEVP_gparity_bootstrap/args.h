#ifndef _FIT_PIPI_COMOVING_GEVP_GPARITY_BOOTSTRAP_ARGS_H
#define _FIT_PIPI_COMOVING_GEVP_GPARITY_BOOTSTRAP_ARGS_H
...
struct Args{
  ...
  Args(): data_dir("data"), 
    ...
    isospin(0),Lt(64), tsep_pipi(4), tstep_pipi(8), t_max(32), traj_start(0), traj_inc(1), traj_lessthan(2), Ascale(1e13), fit_t_min(7), fit_t_max(11), fit_t0(4),
