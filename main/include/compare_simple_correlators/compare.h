...
void compareRelativeDifferences(const jackknifeCorrelationFunctionD &A, const jackknifeCorrelationFunctionD &B, const std::string plot_stub = "reldiff", const bool logscale_y = false){
