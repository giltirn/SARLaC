#ifndef _FIT_PIPI_GND_EXC_SIGMA_GEVP_GPARITY_ARGS_BOOTSTRAP_H_
#define _FIT_PIPI_GND_EXC_SIGMA_GEVP_GPARITY_ARGS_BOOTSTRAP_H_
...
struct Args{
  ...
  Args(): data_dir("data"), 
    ...
    Lt(64), tsep_pipi(4), tstep_pipi(8), tstep_pipi_to_sigma(8), t_max(32), fit_t_min(10), fit_t_max(20), fit_t0(4), 
