#ifndef _FIT_PIPI_COMOVING_GPARITY_BOOTSTRAP_ARGS_H
#define _FIT_PIPI_COMOVING_GPARITY_BOOTSTRAP_ARGS_H
...
struct Args{
  ...
  Args(): data_dir("data"), 
    ...
    fitfunc(FitFuncType::FSimGenMultiState), nstate(3), nboot(1000), block_size(1), resample_table_type(BootResampleTableType::NonOverlappingBlock){}
};
