...
struct Args{
  ...
  Args(): pipi_combined_data_file("pipi_data.hdf5"), ktopipi_amplitude_data_file("ktopipi_data.hdf5"), freeze_file("freeze.hdf5"), Lt(64), correlation_status(Uncorrelated), tsep_pipi(4), tmin_pipi(6), tmax_pipi(25), tmin_k_op(6), tmin_op_pi(4), Ascale(1e13), Cscale(1e13){}
};
