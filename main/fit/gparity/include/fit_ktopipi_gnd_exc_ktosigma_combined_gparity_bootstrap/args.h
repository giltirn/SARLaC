#ifndef _FIT_KTOSIGMA_KTOPIPI_GPARITY_BOOTSTRAP_ARGS_H_
#define _FIT_KTOSIGMA_KTOPIPI_GPARITY_BOOTSTRAP_ARGS_H_
...
struct Args{
  ...
  Args(): data_dir("data"), 
    ...
    correlated(false), Lt(64), tsep_pipi(4), tsep_k_pi({10,12,14,16,18}), tsep_k_sigma({10,12,14,16,18}),  tmin_k_op(6), tmin_op_snk(4), traj_start(0), traj_inc(1), traj_lessthan(2), covariance_matrix(CovarianceMatrix::Regular), block_size(1), nboot(1000), resample_table_type(BootResampleTableType::NonOverlappingBlock){}
