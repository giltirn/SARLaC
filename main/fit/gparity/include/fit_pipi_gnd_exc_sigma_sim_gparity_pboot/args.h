#ifndef _FIT_PIPI_GND_EXC_SIGMA_GPARITY_PBOOT_ARGS_H_
#define _FIT_PIPI_GND_EXC_SIGMA_GPARITY_PBOOT_ARGS_H_
...
struct Args{
  ...
  Args(): data_dir("data"), 
    ...
    fitfunc(FitFuncType::FSimGenTwoState), nstate(3), nboot(1000), block_size(8), do_vacuum_subtraction(true), bin_size(1), timeslice_avg_vac_sub(false), correlated(true), minimizer(MinimizerType::MarquardtLevenberg){}
