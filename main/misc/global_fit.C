...
int main(void){
  ...
  typedef typename composeFitPolicy<FitFunc, frozenFitFuncPolicy, uncorrelatedFitPolicy,MarquardtLevenbergMinimizerPolicy, superJackknifeDistribution<double>, globalFitTypes>::type FitPolicy;
