...
#define ARGS_MEM (int, nsample)(int, Lt)(int, ntest)(int, norig_ens)(DataGenStrategy, data_strat)(int, block_size)(FitFuncType, fitfunc)(CovMatStrategy, cov_strat)(std::string, cov_strat_params_file)(std::vector<preAnalysisType>, preanalysis)(std::vector<std::string>, preanalysis_params_file)(MarquardtLevenbergParameters<double>, MLparams)
...
Args(): nsample(200), Lt(30), ntest(5000), norig_ens(1), block_size(1), fitfunc(FitFuncType::FConstant), cov_strat(CovMatStrategy::Correlated), data_strat(DataGenStrategy::NormalUniform), cov_strat_params_file(""), preanalysis(1,preAnalysisType::None), preanalysis_params_file(1,""){
