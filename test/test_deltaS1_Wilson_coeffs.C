...
//     // double as4mc = ComputeAlphaS::alpha_s(inputs.mcmc, Lambda4, 4, inputs.Nc);
//     // double as4mb = ComputeAlphaS::alpha_s(inputs.mbmb, Lambda4, 4, inputs.Nc);

//     // double Lambda5 = ComputeAlphaS::computeLambda(5, inputs.mbmb, as4mb, inputs.Nc, false);
//     // double as5MW = ComputeAlphaS::alpha_s(inputs.mWmW, Lambda5, 5, inputs.Nc);

//     // double Lambda3 = ComputeAlphaS::computeLambda(3, inputs.mcmc, as4mc, inputs.Nc, false);
//     // double as3mu = ComputeAlphaS::alpha_s(mu, Lambda3, 3, inputs.Nc);

//     // std::cout << "Test Lambda3 " << Lambda3 << " Lambda4 " << Lambda4 << " Lambda5 " << Lambda5 << std::endl;
