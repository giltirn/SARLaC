...
#define GENERATE_PARSER(structname, structmembers) _GENERATE_PARSER_EXT(structname, structmembers)

//Same as the above but with the grammar namespace manually specified
#define GENERATE_PARSER_GM(structname, grammar, structmembers) _GENERATE_PARSER_EXT_GM(structname, grammar, structmembers)

//Generate the parser from inside the CPSfit namespace
#define GENERATE_PARSER_INT(structname, structmembers) _GENERATE_PARSER_INT(structname, structmembers)
...
#define GENERATE_ENUM_PARSER(enumname, enummembers) _GENERATE_ENUM_PARSER_EXT(enumname, enummembers) 

//Define an enum and a parser to go along with it
//Usage: GENERATE_ENUM_AND_PARSER( MY_ENUM NAME, (MY_ELEM1)(MY_ELEM2)(MY_ELEM3)......   )
#define GENERATE_ENUM_AND_PARSER(enumname, enummembers) _GENERATE_ENUM_AND_PARSER_EXT(enumname, enummembers) 
  

//Same as above but from inside CPSfit namespace
#define GENERATE_ENUM_PARSER_INT(enumname, enummembers) _GENERATE_ENUM_PARSER_INT(enumname, enummembers) 

//Define an enum and a parser to go along with it
//Usage: GENERATE_ENUM_AND_PARSER( MY_ENUM NAME, (MY_ELEM1)(MY_ELEM2)(MY_ELEM3)......   )
#define GENERATE_ENUM_AND_PARSER_INT(enumname, enummembers) _GENERATE_ENUM_AND_PARSER_INT(enumname, enummembers) 
